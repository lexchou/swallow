...
public:
    void testFunc()
    {
        ...
        IdentifierPtr id;
        IntegerLiteralPtr i;
        CPPUNIT_ASSERT(func = std::dynamic_pointer_cast<FunctionDef>(root));
        ...
        CPPUNIT_ASSERT(add = std::dynamic_pointer_cast<BinaryOperator>(ret->getExpression()));
        ASSERT_EQUALS(L"+", add->getOperator().c_str());
        
        CPPUNIT_ASSERT(id = std::dynamic_pointer_cast<Identifier>(add->getLHS()));
        CPPUNIT_ASSERT(i = std::dynamic_pointer_cast<IntegerLiteral>(add->getRHS()));
    ...
    void testFunc_ReturnFunc()
    {
        ...
        CPPUNIT_ASSERT(tupleType = std::dynamic_pointer_cast<TupleType>(rettype->getArgumentsType()));
        CPPUNIT_ASSERT(!tupleType->getVariadicParameters());
        CPPUNIT_ASSERT_EQUAL(1, tupleType->numElements());
        
        CPPUNIT_ASSERT(type = std::dynamic_pointer_cast<TypeIdentifier>(tupleType->getElementType(0)));
        ASSERT_EQUALS(L"Int", type->getName().c_str());
        
        CPPUNIT_ASSERT(type = std::dynamic_pointer_cast<TypeIdentifier>(rettype->getReturnType()));
        ASSERT_EQUALS(L"Int", type->getName().c_str());
    ...
    void testFunc_ReturnTuple()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(1, params->numParameters());
        CPPUNIT_ASSERT(!params->isVariadicParameters());
        CPPUNIT_ASSERT(rettype = std::dynamic_pointer_cast<TupleType>(func->getReturnType()));
        ...
        CPPUNIT_ASSERT(id = std::dynamic_pointer_cast<TypeIdentifier>(rettype->getElementType(0)));
        ...
        CPPUNIT_ASSERT(id = std::dynamic_pointer_cast<TypeIdentifier>(rettype->getElementType(1)));
        ASSERT_EQUALS(L"Int", id->getName().c_str());
        
        CPPUNIT_ASSERT(!rettype->getElement(2).inout);
        ASSERT_EQUALS(L"others", rettype->getElement(2).name.c_str());
        CPPUNIT_ASSERT(id = std::dynamic_pointer_cast<TypeIdentifier>(rettype->getElementType(2)));
        ASSERT_EQUALS(L"Int", id->getName().c_str());
    ...
    void testFunc_FuncType()
    {
        ...
        CPPUNIT_ASSERT(t = std::dynamic_pointer_cast<TypeIdentifier>(args->getElementType(0)));
        ASSERT_EQUALS(L"Int", t->getName().c_str());
        CPPUNIT_ASSERT(t = std::dynamic_pointer_cast<TypeIdentifier>(args->getElementType(1)));
        ASSERT_EQUALS(L"Int", t->getName().c_str());
        
        
        CPPUNIT_ASSERT(t = std::dynamic_pointer_cast<TypeIdentifier>(type->getReturnType()));
        ASSERT_EQUALS(L"Int", t->getName().c_str());
    ...
    void testFunc_NestedFunc()
    {
        ...
        CPPUNIT_ASSERT(cb = std::dynamic_pointer_cast<CodeBlock>(func->getBody()));
        
        CPPUNIT_ASSERT(func = std::dynamic_pointer_cast<FunctionDef>(cb->getStatement(0)));
        ASSERT_EQUALS(L"stepForward", func->getName().c_str());
        CPPUNIT_ASSERT_EQUAL(1, func->numParameters());
        CPPUNIT_ASSERT_EQUAL(1, func->getParameters(0)->numParameters());

        CPPUNIT_ASSERT(func = std::dynamic_pointer_cast<FunctionDef>(cb->getStatement(1)));
