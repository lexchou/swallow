...
public:
    ...
    void testDecimal()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL(10, token.number.base);
        CPPUNIT_ASSERT_EQUAL((int64_t)3, token.number.value);
        ASSERT_EQUALS(L"3", token.c_str());
        
        CPPUNIT_ASSERT(tokenizer.next(token));
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL(10, token.number.base);
        CPPUNIT_ASSERT_EQUAL((int64_t)345, token.number.value);
        ...
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL(10, token.number.base);
        CPPUNIT_ASSERT_EQUAL((int64_t)34333444, token.number.value);
        ASSERT_EQUALS(L"34_333_444", token.c_str());
        
        CPPUNIT_ASSERT(tokenizer.next(token));
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL((int64_t)43, token.number.value);
        ASSERT_EQUALS(L"+43", token.c_str());
        
        CPPUNIT_ASSERT(tokenizer.next(token));
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL(10, token.number.base);
        CPPUNIT_ASSERT_EQUAL((int64_t)-34, token.number.value);
    ...
    void testBinary()
    {
        ...
        CPPUNIT_ASSERT_EQUAL((int64_t)272, token.number.value);
        ASSERT_EQUALS(L"0b100_010_000", token.c_str());
        
        CPPUNIT_ASSERT(tokenizer.next(token));
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL(2, token.number.base);
        CPPUNIT_ASSERT_EQUAL((int64_t)0, token.number.value);
        ...
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL(2, token.number.base);
        CPPUNIT_ASSERT_EQUAL((int64_t)-1, token.number.value);
    ...
    void testHexadecimal()
    {
        ...
        CPPUNIT_ASSERT_EQUAL((int64_t)0xffe, token.number.value);
        ...
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL(16, token.number.base);
        CPPUNIT_ASSERT_EQUAL((int64_t)0xaa, token.number.value);
        ASSERT_EQUALS(L"0xaa", token.c_str());
        
        CPPUNIT_ASSERT(tokenizer.next(token));
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL((int64_t)-0xacd, token.number.value);
        CPPUNIT_ASSERT_EQUAL(16, token.number.base);
        ASSERT_EQUALS(L"-0xacd", token.c_str());
        
        CPPUNIT_ASSERT(tokenizer.next(token));
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL((int64_t)0xfe, token.number.value);
        CPPUNIT_ASSERT_EQUAL(16, token.number.base);
    ...
    void testOctal()
    {
        ...
        CPPUNIT_ASSERT_EQUAL((int64_t)76733439, token.number.value);
        ASSERT_EQUALS(L"0o444_555_777", token.c_str());
        
        CPPUNIT_ASSERT(tokenizer.next(token));
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL(8, token.number.base);
        CPPUNIT_ASSERT_EQUAL((int64_t)224, token.number.value);
        ...
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL(8, token.number.base);
        CPPUNIT_ASSERT_EQUAL((int64_t)-126, token.number.value);
    ...
    void testDecimalFloat()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(TokenType::Float, token.type);
        CPPUNIT_ASSERT_EQUAL(10, token.number.base);
        CPPUNIT_ASSERT_EQUAL((double)1000.0, token.number.dvalue);
        ...
        CPPUNIT_ASSERT_EQUAL(TokenType::Integer, token.type);
        CPPUNIT_ASSERT_EQUAL(10, token.number.base);
        CPPUNIT_ASSERT_EQUAL((double)345.0, token.number.dvalue);
        ASSERT_EQUALS(L"345", token.c_str());
        
        CPPUNIT_ASSERT(tokenizer.next(token));
        CPPUNIT_ASSERT_EQUAL(TokenType::Float, token.type);
        CPPUNIT_ASSERT_EQUAL(10, token.number.base);
        CPPUNIT_ASSERT_EQUAL((double)345.543, token.number.dvalue);
        ...
        CPPUNIT_ASSERT_EQUAL(TokenType::Float, token.type);
        CPPUNIT_ASSERT_EQUAL(10, token.number.base);
        CPPUNIT_ASSERT_EQUAL((double)-345.6e7, token.number.dvalue);
        ASSERT_EQUALS(L"-345.6e7", token.c_str());
        
        CPPUNIT_ASSERT(tokenizer.next(token));
        CPPUNIT_ASSERT_EQUAL(TokenType::Float, token.type);
        CPPUNIT_ASSERT_EQUAL(10, token.number.base);
        CPPUNIT_ASSERT_EQUAL((double)+3e4, token.number.dvalue);
    ...
    void testHexadecimalFloat()
    {
        ...
        CPPUNIT_ASSERT(tokenizer.next(token));
        CPPUNIT_ASSERT_EQUAL(TokenType::Float, token.type);
        CPPUNIT_ASSERT_EQUAL((double)837.375, token.number.dvalue);
        CPPUNIT_ASSERT_EQUAL(16, token.number.base);
        ASSERT_EQUALS(L"0x345.6", token.c_str());
        
        CPPUNIT_ASSERT(tokenizer.next(token));
        CPPUNIT_ASSERT_EQUAL(TokenType::Float, token.type);
        CPPUNIT_ASSERT_EQUAL(16, token.number.base);
        CPPUNIT_ASSERT_EQUAL((double)-107184, token.number.dvalue);
        ASSERT_EQUALS(L"-0x345.6p7", token.c_str());
        
        CPPUNIT_ASSERT(tokenizer.next(token));
        CPPUNIT_ASSERT_EQUAL(TokenType::Float, token.type);
        CPPUNIT_ASSERT_EQUAL(16, token.number.base);
        CPPUNIT_ASSERT_EQUAL((double)48, token.number.dvalue);
